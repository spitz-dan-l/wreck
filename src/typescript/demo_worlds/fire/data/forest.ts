...
export const FOREST: StorySpec = {
    ...
    events: [
        {
            index: 1, voice: 'the seed', prose: 1,
            command: 'take root',
        ...
        {
            index: 8, voice: 'the weather', prose: 8,
        ...
        {
            index: 9, voice: 'the fire', prose: 9,
    ...
    traps: [
        {
            ...
            nudge: 'Not the one on the board, my dear. That one we are looking for. Lend the story a fire of its own; it will have no body either, and you will hear how alike they sound.'
        }
    ],
    candidates: {
        'the Voice of Fire': {
    ...
    feelings: [
        ...
        'inevitable, because the board said so',
        'a bit familiar, because the thin voices sounded like the one on the right'
    ],
    apply_text: {
        first: 'The forest grew for a hundred years so that it could burn for a day. That is what the board says. The board is not wrong.'
    }
};
