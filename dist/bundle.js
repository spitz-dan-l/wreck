...
let hex_oms = () => [{
    ...
    handle_command: venience_world_1.wrap_handler(function* (parser) {
        ...
        let intro_consumer = venience_world_1.wrap_handler(function* (parser) {
            let option = yield parser.consume_option(intro_perceptions.map(p => datatypes_1.annotate([p], {
                enabled: !this.state.has_regarded[p]
            })));
            return this.regard(option);
        });
        return parser_1.combine.call(this, parser, [intro_consumer]);
    }),
...
const datatypes_1 = __webpack_require__(1);
const parser_1 = __webpack_require__(2);
const ObserverMomentIDs = datatypes_1.infer_literal_array('imagining 1', 'imagining 2');
