...
let prologue_oms = () => [
    ...
    },
    {
        ...
        handle_command: venience_world_1.wrap_handler(function* (parser) {
            ...
            yield parser.consume_option([
                datatypes_1.set_enabled(['panic'], false),
                datatypes_1.set_enabled(['dread'], true)
            ]);
            yield parser.done();
    ...
    },
    {
        ...
        handle_command: venience_world_1.wrap_handler(function* (parser) {
            ...
            let judge_consumer = venience_world_1.wrap_handler(function* (parser) {
                ...
                yield parser.consume_filler(['the']);
                yield parser.consume_option([
                    datatypes_1.annotate(['direction', 'of', 'gravity'], { enabled: interp_step === 0 }),
                    datatypes_1.annotate(['slickness', 'of', 'the', 'ice'], { enabled: interp_step === 1 }),
                ]);
                yield parser.done();
                return next_interp();
            });
...
//# sourceMappingURL=00_prologue.js.map